...
## Recording logistics {visibility="hidden"}
...
Include the error message you receive and the line of code that caused it
...
::: {.column width="30%"}
![](images/Screenshot 2025-09-25 at 15-18-27 punxsutawney phil - Google Search.png){fig-align="center"}
:::
:::::
...
-   Every groundhog in `prediction`s appears in `groundhogs`
